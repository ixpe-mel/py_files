...
import importlib
importlib.reload(Gc)
def G_span(mod_bin_number,data_1,lc_ref,GTI,bin_length, seg_length, fmin, fmax):
    ...
    partial_G_calc = partial(Gc.G_calc, data_1=data_1,lc_ref=lc_ref,GTI=GTI,bin_length=bin_length, seg_length=seg_length, fmin=fmin, fmax=fmax,mod_bin_number=mod_bin_number)
