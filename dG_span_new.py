...
def dG_span(mod_bin_number,
    ...
    if coherence_corrector==True and spurious_sub==True:
        ...
        partial_dG_calc=partial(dGc.dG_calc,
                                lc_1_ref=lc_1_ref,lc_2_ref=lc_2_ref,data_2=data_2,n=n,m=m,fmin=fmin,fmax=fmax,seg_length=seg_length,bin_length=bin_length,GTI=GTI,ps_2_mean=ps_2_mean,cs_ref_real_mean=cs_ref_real_mean,spurious_sub=False)
        ...
        partial_dG_calc=partial(dGc.dG_calc, 
                                lc_1_ref=lc_1_ref,lc_2_ref=lc_2_ref,data_2=data_2,n=n,m=m,fmin=fmin,fmax=fmax,seg_length=seg_length,bin_length=bin_length,GTI=GTI,coherence_corrector=False,spurious_sub=False)
        for i in zip(mod_min_array,mod_max_array,lc_subject_span,G_real_span,G_im_span):
            result.append(partial_dG_calc(i[0],i[1],i[2],i[3],i[4]))