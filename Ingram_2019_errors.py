...
def ingr_2019_errs_cc(real_G,im_G,lc_subject,cs_ref_real_mean,ps_2_mean,n,m,fmin,fmax,seg_length,norm):
   

    ps_1_subject=Powerspectrum.from_lightcurve(lc_subject,seg_length,norm=norm)
...
def ingr_2019_errs(real_G,im_G,lc_subject,cs_ref_real_mean,ps_2_mean,n,m,fmin,fmax,seg_length,norm):
    modulus_G=np.sqrt((real_G**2)+(im_G**2))
