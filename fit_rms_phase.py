...
def fit_line(av_mod,frac_rms,frac_rms_err,phase,phase_err):    
    ...
    parameters_line_phase, covariance_phase = curve_fit(fm.line, np.array(av_mod) ,phase,maxfev=50000) #defining the returns of curvefit
...
def fit_sine_90(av_mod,frac_rms,frac_rms_err,phase,phase_err):
    ...
    phase_sin90_chi=cs.chi_square(phase,phase_err,fit_y_sin90_phase)
...
def fit_sine_180(av_mod,frac_rms,frac_rms_err,phase,phase_err):
    ...
    phase_sin180_chi=cs.chi_square(phase,phase_err,fit_y_sin180_phase,dof_sin180_rms,dof_sin180_phase)
...
def fit_sinsum(av_mod,frac_rms,frac_rms_err,phase,phase_err):
    ...
    phase_sinsum_chi=cs.chi_square(phase,phase_err,fit_y_sinsum_phase,dof_sinsum_rms,dof_sinsum_phase)
